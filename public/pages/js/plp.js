                ...
                template += `   <div class="col-lg-3 col-md-4 col-sm-6">
                                    <div class="single-product-item text-center">
                                        <div class="products-images">
                                            <a href="/skincare/`+item.id+`" class="product-thumbnail">
                                                <img src="`+item.image+`" alt="Product Images" height="300">
                                            </a>
                                            <div class="product-actions">
                                                <a href="/skincare/`+item.id+`"><i class="p-icon icon-plus"></i><span class="tool-tip">Quick View</span></a>
                                                <a href="#"><i class="p-icon icon-bag2"></i> <span class="tool-tip">Add to cart</span></a>
                                            </div>
                                        </div>
                                        <div class="product-content">
                                            <h6 class="product-title">
                                                <a href="/skincare/`+item.id+`">`+item.nama+`</a>
                                            </h6>
